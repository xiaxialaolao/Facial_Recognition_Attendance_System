...
class FrameSourceManager:
    """帧源管理器"""
    def __init__(self, width, height, frame_rate=15):  # 将默认帧率改为15
        # 使用4:3比例的高分辨率
        self.width = 1920  # 使用4:3比例的宽度
        self.height = 1080  # 保持原有高度
...
class FaceRecognitionSystem:
    ...
    def display_loop(self):
        ...
        cv2.resizeWindow("Face Recognition", 2560, 720)  # 调整显示尺寸为2560x1440
...
def main():
    ...
    try:
        ...
        if not os.path.exists("Face_Image"):
            logger.info("Creating Face_Image directory")
